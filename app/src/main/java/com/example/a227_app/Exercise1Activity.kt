...
class Exercise1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animationView.setAnimation(R.raw.situps)
        animationView.playAnimation()

        findViewById<TextView>(R.id.exerciseName).text = "Crunches"
    ...
    private fun startTimer(duration: Long) {
        ...
        timer = object : CountDownTimer(duration, 1000) {
            ...
            override fun onFinish() {
                ...
                Toast.makeText(this@Exercise1Activity, "Great Job!", Toast.LENGTH_SHORT).show()
            }
        }.start()
    }
