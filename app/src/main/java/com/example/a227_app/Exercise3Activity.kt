...
class Exercise3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animationView.setAnimation(R.raw.lify)
        animationView.playAnimation()

        findViewById<TextView>(R.id.exerciseName).text = "Push-Ups"
    ...
    private fun startTimer(duration: Long) {
        ...
        timer = object : CountDownTimer(duration, 1000) {
            ...
            override fun onFinish() {
                ...
                Toast.makeText(this@Exercise3Activity, "Great Effort!", Toast.LENGTH_SHORT).show()
            }
        }.start()
    }
